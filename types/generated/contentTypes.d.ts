...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    card_accent_color: Schema.Attribute.String &
      Schema.Attribute.CustomField<'plugin::color-picker.color'>;
    card_filter_categories: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::tagsinput.tags'>;
    card_placement: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::group-arrange-strapi-plugin.order2d',
        {
          group: {
            columnsNumber: 3;
...
export interface ApiChartChart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    chart_title: Schema.Attribute.String & Schema.Attribute.Required;
    chart_type: Schema.Attribute.Enumeration<['line', 'bar', 'stat']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_date: Schema.Attribute.Date & Schema.Attribute.Required;
    data_source: Schema.Attribute.DynamicZone<
      [
        'datasets.json-data',
        'datasets.csv-upload',
        'datasets.api-link',
